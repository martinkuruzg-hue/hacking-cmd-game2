...
var puntos: int
#Variable ficheros 
var lista_carpetas = ["home"] #Carpeta ACTUAL

var jerarquia_carpetas = {"home":0 , "Documents":1, "Desktop":1, "Download":1, "a":2,"e":3} #CARPETAS EXISTENTES
var fichero = "~\\home>"
...
func _process(delta: float) -> void:
 #PENDIENTE: OPTIMIZAR PARA NO LLAMAR SIEMPRE
...
func salir_carpeta(input):
	...
	if lista_carpetas.size()>1 and "home" in lista_carpetas:
